...
## このプログラムの目的
このプログラムは、**Express.js**を使った簡易的なウェブアプリケーションである。いくつかの機能を提供し、ブラウザを通じて次のようなインタラクションを実現する：
1. 挨拶メッセージの表示
2. 画像の表示
3. サイコロによる運勢占い
4. じゃんけんゲーム
...
1. コマンドラインでサーバーを起動:
   ...
   ```
2. ブラウザでアクセス:
   - 挨拶: `http://localhost:8080/hello1`
   - 画像: `http://localhost:8080/icon`
   - 運勢: `http://localhost:8080/luck`
